...
<head>
    ...
    <title>simulador de negocios tecnologias web</title>
    ...
    <script>
        function delete_tipoinversion(id_to_delete)
        {
            var confirmation = confirm(String.fromCharCode(191)+'Est\u00E1 seguro de que desea eliminar la carrera con clave '+ id_to_delete);

            if(confirmation)
            {
                window.location = "borrar_tiposinversiones.jsp?idtiposInversiones="+id_to_delete;
            }
        }
    </script>
</head>
